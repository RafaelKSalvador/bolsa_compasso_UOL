...
public class LeilaoTest {
    ...
    public void deve_DevolveMaiorLance_QuandoRecebeMaisDeUmLanceEmOrdemCrescente() {
        ...
        CONSOLE.propoe(new Lance(new Usuario("Krysler"), 200.0));
    ...
    public void deve_DevolverTresMaioresLances_QuandoRecebeExatosTresLances() {
        CONSOLE.propoe(new Lance(RAFAEL, 200.0));
        CONSOLE.propoe(new Lance(new Usuario("Krysler"), 300.0));
        ...
        assertThat(tresMaioresLancesDevolvidos,
                both(Matchers.<Lance>hasSize(3))
                        .and(contains(
                                ...
                                new Lance(new Usuario("Krysler"), 300.0),
    ...
    public void deve_DevolverTresMaioresLances_QuandoRecebeApenasDoisLances() {
        ...
        CONSOLE.propoe(new Lance(new Usuario("Krysler"), 400.0));
    ...
    public void deve_DevolverTresMaioresLances_QuandoRecebeMaisDeTresLances() {
        CONSOLE.propoe(new Lance(RAFAEL, 300.0));
        final Usuario KRYSLER = new Usuario("Krysler");
        CONSOLE.propoe(new Lance(KRYSLER, 400.0));
        CONSOLE.propoe(new Lance(RAFAEL, 500.0));
        CONSOLE.propoe(new Lance(KRYSLER, 600.0));
    ...
    public void naoDeve_AdicionarLance_QuandoForOMesmoUsuariDoUltimoLance() {
        CONSOLE.propoe(new Lance(RAFAEL, 500.0));
        CONSOLE.propoe(new Lance(RAFAEL, 600.0));
    }
    ...
    public void naoDeve_AdicionarLance_QuandoUsuarioDerCincoLances() {
        CONSOLE.propoe(new Lance(RAFAEL, 100.0));
        final Usuario KRYSLER = new Usuario("Krysler");
        CONSOLE.propoe(new Lance(KRYSLER, 200.0));
        CONSOLE.propoe(new Lance(RAFAEL, 300.0));
        CONSOLE.propoe(new Lance(KRYSLER, 400.0));
        CONSOLE.propoe(new Lance(RAFAEL, 500.0));
        CONSOLE.propoe(new Lance(KRYSLER, 600.0));
        CONSOLE.propoe(new Lance(RAFAEL, 700.0));
        CONSOLE.propoe(new Lance(KRYSLER, 800.0));
        CONSOLE.propoe(new Lance(RAFAEL, 900.0));
        CONSOLE.propoe(new Lance(KRYSLER, 1000.0));
